...
<?php require_once "../service/admin_service.php"; ?>
...
$unerr=$pwerr="";
	...
	if(isset($_POST['Login']))
	{
		...
		else if(admins_GetByEmail($un)!=null)
		{
			if(admins_GetByEmail($un)['password']==$pw){
			setcookie("AdminLogged",$un,time()+30*24*60*60);
			//var_dump($_COOKIE["CustomerLogged"]);
